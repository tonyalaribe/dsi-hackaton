...
func (Base) Get(c *gin.Context) {
	c.JSON(http.StatusMethodNotAllowed, Message{APIMessage: "not allowed ge"})
}

func (Base) Post(c *gin.Context) {
	c.JSON(http.StatusMethodNotAllowed, Message{APIMessage: "not allowed x"})
}

func (Base) Head(c *gin.Context) {
	c.JSON(http.StatusMethodNotAllowed, Message{APIMessage: "not allowed r"})
}

func (Base) Delete(c *gin.Context) {
	c.JSON(http.StatusMethodNotAllowed, Message{APIMessage: "not allowed m"})
}

func (Base) Put(c *gin.Context) {
	c.JSON(http.StatusMethodNotAllowed, Message{APIMessage: "not allowed n"})
}

func (Base) Patch(c *gin.Context) {
	c.JSON(http.StatusMethodNotAllowed, Message{APIMessage: "not allowed c"})
}

func (Base) Options(c *gin.Context) {
	c.JSON(http.StatusMethodNotAllowed, Message{APIMessage: "not allowed opt"})
}
